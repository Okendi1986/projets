...
<!-- Circle Ends 
      ...
      <h3 class="text-center wowload fadeInUp">Process</h3>
        <ul class="row text-center list-inline  wowload bounceInUp">
               <li>
                <span><i class="fas fa-bolt"></i><b>Puissance</b></span>
            </li>
            <li>
                <span><i class="fas fa-tachometer-alt"></i><b>Vitesse</b></span>
            </li>
            <li>
                <span><i class="fas fa-shield-alt"></i><b>Endurance</b></span>
            </li>
            <li>
                <span><i class="fa fa-car"></i><b>nouveaux</b></span>
            </li>        
            <li>
...
#Cirlce Ends --><?php /**PATH C:\Users\HP\Desktop\projets\Appvoiture\resources\views/layout/modal.blade.php ENDPATH**/ ?>